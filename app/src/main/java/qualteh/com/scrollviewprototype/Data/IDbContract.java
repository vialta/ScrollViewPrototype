...
public interface IDbContract
{
    ...
    public static final String COLUMN_COMMISION_ID = "_commission_id";
    ...
    public static final String COLUMN_COMMISION_STROKE_COLOR = "_commission_stroke_color";
    public static final String COLUMN_COMMISION_STROKE_WIDTH = "_commission_stroke_width";
    public static final String COLUMN_COMMISION_COORDINATE_ID = "_id";
    ...
    public static final String CREATE_TABLE_COMMISION = "CREATE TABLE IF NOT EXISTS commission_table (_id INTEGER PRIMARY KEY AUTOINCREMENT, _commission_id VARCHAR(10) NOT NULL, _commission_stroke_width INTEGER NOT NULL, _commission_stroke_color VARCHAR(7) NOT NULL )";
    public static final String CREATE_TABLE_COMMISION_COORDINATE = "CREATE TABLE IF NOT EXISTS commission_table_coordinates (_id INTEGER PRIMARY KEY AUTOINCREMENT, _commission_id INTEGER NOT NULL, _x REAL NOT NULL, _y REAL NOT NULL)";
    ...
    public static final String DROP_TABLE_COMISSION = "DROP TABLE IF EXISTS commission_table";
    public static final String DROP_TABLE_COMISSION_COORDINATES = "DROP TABLE IF EXISTS commission_table_coordinates";
    ...
    public static final String TABLE_NAME_COMMISION = "commission_table";
    public static final String TABLE_NAME_COMMISION_COORDINATES = "commission_table_coordinates";
